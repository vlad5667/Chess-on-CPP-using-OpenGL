...
namespace ChessGame {
	...
	int deletedPieceId; // «м≥нна, що збер≥гаЇ ≥дентиф≥катор ф≥гури, що була видалена з дошки останньою
	int deletedPieceZ, deletedPieceX; // «м≥нн≥, що збер≥гають координати до видаленн€ ф≥гури, що була видалена з дошки останньою
